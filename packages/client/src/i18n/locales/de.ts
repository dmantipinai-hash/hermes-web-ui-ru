...
jobTriggered: 'Job ausgelost',
  ...
  kanban: {
    ...
    drawer: {
      ...
      noTurn: 'Zug nicht gesetzt',
      sentToAgent: 'Aufgabe an Agent gesendet',
      returnedToWork: 'Aufgabe zurückgesetzt',
      accepted: 'Aufgabe akzeptiert',
      needsRevisionComment: 'Überarbeitung erforderlich',
      sentForRevision: 'Zur Überarbeitung gesendet',
    },
    labels: 'Labels',
    ...
    addChecklist: 'Punkt hinzufügen...',
    info: 'Informationen',
    uiColumnsMode: 'Kollaborationsansicht',
    technicalMode: 'Technische Ansicht',
    compactMode: 'Kompakt',
    fullMode: 'Voll',
  },
