export default {
  ...
  kanban: {
    ...
    action: {
      ...
      assign: 'Assign',
      assignTo: 'Assign to...',
      handoffComment: 'Handoff comment (optional)',
    },
    message: {
    ...
    drawer: {
      ...
      returnedToWork: 'Task returned to work',
      accepted: 'Task accepted',
      needsRevisionComment: 'Revision needed',
    ...
    info: 'Information',
    uiColumnsMode: 'Collaboration View',
    technicalMode: 'Technical View',
    compactMode: 'Compact',
    fullMode: 'Full',
  },
