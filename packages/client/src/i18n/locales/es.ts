...
jobTriggered: 'Job ejecutado',
  ...
  kanban: {
    ...
    goalPlaceholder: 'Haz clic para establecer un objetivo',
    edit: 'Editar',
    save: 'Guardar',
    cancel: 'Cancelar',
    totalTasks: 'Total',
    ...
    milestoneDesc: 'Descripción (opcional)',
    ...
    drawer: {
      ...
      noTurn: 'Turno no asignado',
      sentToAgent: 'Tarea enviada al agente',
      returnedToWork: 'Tarea devuelta al trabajo',
      accepted: 'Tarea aceptada',
      needsRevisionComment: 'Revisión necesaria',
      sentForRevision: 'Enviada para revisión',
    },
    labels: 'Etiquetas',
    ...
    addChecklist: 'Agregar elemento...',
    info: 'Información',
    uiColumnsMode: 'Vista de colaboración',
  ...
  folders: {
    ...
    noFolders: 'Sin carpetas de espacio de trabajo',
  },
}
