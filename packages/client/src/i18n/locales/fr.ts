...
jobTriggered: 'Job declenche',
  ...
  kanban: {
    ...
    goalPlaceholder: 'Cliquez pour définir un objectif',
    edit: 'Modifier',
    save: 'Enregistrer',
    cancel: 'Annuler',
    totalTasks: 'Total',
    ...
    milestoneDesc: 'Description (facultatif)',
    noMilestone: 'Aucun jalon',
    filterAll: 'Tous',
    uiColumns: {
      inbox: 'Boîte de réception',
      todo: 'À faire',
      agent_working: 'Agent actif',
      waiting_me: 'En attente',
      done: 'Terminé',
      archive: 'Archive',
    },
    drawer: {
      ...
      returnToWork: 'Remettre en cours',
      accept: 'Accepter',
      ...
      noTurn: 'Tour non défini',
      sentToAgent: 'Tâche envoyée à l\'agent',
      returnedToWork: 'Tâche remise en cours',
      accepted: 'Tâche acceptée',
      needsRevisionComment: 'Révision requise',
      sentForRevision: "Envoyée pour révision",
    },
    labels: 'Étiquettes',
    addLabel: 'Ajouter étiquette...',
    dueDate: 'Date limite',
    setDueDate: 'Définir la date limite',
    checklist: 'Liste de contrôle',
    addChecklist: 'Ajouter un élément...',
    info: 'Informations',
    uiColumnsMode: 'Vue collaboration',
    technicalMode: 'Vue technique',
    compactMode: 'Compact',
    fullMode: 'Complet',
  },
  ...
  folders: {
    ...
    noFolders: 'Aucun dossier d\'espace de travail',
  },
}
