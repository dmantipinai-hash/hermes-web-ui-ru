export default {
  ...
  kanban: {
    ...
    uiColumns: {
      inbox: '받은편지함',
      todo: '할 일',
      agent_working: '에이전트 작업 중',
      waiting_me: '나를 기다리는 중',
      done: '완료',
      archive: '보관',
    },
    drawer: {
      ...
      context: '컨텍스트',
      history: '기록',
      sendToAgent: '에이전트에 전송',
      returnToWork: '작업으로 돌아가기',
      accept: '수락',
      needsRevision: '수정 필요',
      block: '차단',
      unblock: '차단 해제',
      ...
      waitingForYou: '대기 중',
      noTurn: '턴 미설정',
      sentToAgent: '에이전트에게 전송됨',
      returnedToWork: '작업으로 복귀됨',
      accepted: '작업 수락됨',
      needsRevisionComment: '수정이 필요합니다',
      sentForRevision: '수정 요청 전송됨',
    },
    labels: '라벨',
    addLabel: '라벨 추가...',
    dueDate: '마감일',
