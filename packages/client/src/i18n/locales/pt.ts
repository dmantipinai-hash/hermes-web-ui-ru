...
jobTriggered: 'Job acionado',
  ...
  kanban: {
    ...
    message: {
      ...
      moveFailed: 'Falha ao mover a tarefa',
    ...
    goalPlaceholder: 'Clique para definir um objetivo',
    edit: 'Editar',
    save: 'Salvar',
    cancel: 'Cancelar',
    totalTasks: 'Total',
    ...
    milestoneDesc: 'Descrição (opcional)',
    ...
    drawer: {
      ...
      returnToWork: 'Retornar ao trabalho',
      accept: 'Aceitar',
      ...
      noTurn: 'Turno não definido',
      sentToAgent: 'Tarefa enviada ao agente',
      returnedToWork: 'Tarefa retornada ao trabalho',
      accepted: 'Tarefa aceita',
      needsRevisionComment: 'Revisão necessária',
      sentForRevision: 'Enviada para revisão',
    },
    labels: 'Etiquetas',
    ...
    addChecklist: 'Adicionar item...',
    info: 'Informações',
    uiColumnsMode: 'Vista de colaboração',
    technicalMode: 'Vista técnica',
  ...
  folders: {
    ...
    noFolders: 'Sem pastas do espaço de trabalho',
  },
}
